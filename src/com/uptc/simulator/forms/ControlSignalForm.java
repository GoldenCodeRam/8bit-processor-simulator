...
public class ControlSignalForm {
  ...
  public ProgramCounterForm programCounterForm;
  public MemoryAddressRegisterForm memoryAddressRegisterForm;
  public InstructionRegisterForm instructionRegisterForm;
  public RamForm ramForm;
  public ARegisterForm aRegisterForm;
  public BRegisterForm bRegisterForm;
  public ALUForm ALUForm;
  public OutputRegisterForm outputRegisterForm;
  ...
  public boolean ramOutSignal() { return ROCheckBox.isSelected(); }
  public boolean instructionRegisterOutSignal() { return IOCheckBox.isSelected(); }
  public boolean arithmeticLogicUnitOutSignal() { return EOCheckBox.isSelected(); }
  ...
  public void nextPulse() {
    if (programCounterOutSignal() && memoryAddressRegisterInSignal()) {
      System.out.println("CO - MI");
      String programCounterValue = programCounterForm.getProgramCounterValue();
      this.updateBus(programCounterValue);
      this.updateMemoryAddressRegister(programCounterValue);
    } else if (ramOutSignal() && instructionRegisterInSignal()) {
      System.out.println("RO - II");
      String ramValue = ramForm.getValue();
      this.updateBus(ramValue);
      this.updateInstructionRegister(ramValue);
    } else if (instructionRegisterOutSignal() && memoryAddressRegisterInSignal()) {
      System.out.println("IO - MI");
      String instructionRegisterValue = instructionRegisterForm.getInstructionRegisterValue();
      this.updateBus(instructionRegisterValue);
      this.updateMemoryAddressRegister(instructionRegisterValue);
    } else if (ramOutSignal() && aRegisterInSignal()) {
      System.out.println("RO - AI");
      String ramValue = ramForm.getValue();
      this.updateBus(ramValue);
      this.updateARegister(ramValue);
    } else if (ramOutSignal() && bRegisterInSignal()) {
      System.out.println("RO - BI");
      String ramValue = ramForm.getValue();
      this.updateBus(ramValue);
      this.updateBRegister(ramValue);
    } else if (arithmeticLogicUnitOutSignal() && aRegisterInSignal()) {
      System.out.println("EO - AI");
      String ALUValue = ALUForm.getALUValue();
      this.updateBus(ALUValue);
      this.updateARegister(ALUValue);
    } else if (aRegisterOutSignal() && outputRegisterInSignal()) {
      System.out.println("AO - OI");
      String aRegisterValue = aRegisterForm.getARegisterValue();
      this.updateBus(aRegisterValue);
      this.updateOutputRegister(aRegisterValue);
    } else if (counterEnableSignal()) {
      this.programCounterForm.counterEnable();
    }
  }

  private void updateBus(String value) {
    busForm.setBusValue(value);
  }

  private void updateMemoryAddressRegister(String value) {
    memoryAddressRegisterForm.setMemoryAddressRegisterValue(value);
  }

  private void updateInstructionRegister(String value) {
    instructionRegisterForm.setInstructionRegisterValue(value);
  }

  private void updateARegister(String value) {
    aRegisterForm.setARegisterValue(value);
  }

  private void updateBRegister(String value) {
    bRegisterForm.setBRegisterValue(value);
  }

  private void updateOutputRegister(String value) {
    outputRegisterForm.setOutputRegisterValue(value);
  }
